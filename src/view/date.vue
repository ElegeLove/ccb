            ...
            >
                <div v-if="datashow">
                    ...
                    >
                        <a-form-item label="食堂：">
                            ...
                            >
                                ...
                                <a-select-option value="one">一食堂</a-select-option>
                                <a-select-option value="two">二食堂</a-select-option>
                                <a-select-option value="three">三食堂</a-select-option>
                                <a-select-option value="four">四食堂</a-select-option>
                            </a-select>
                            <!-- </a-form-item> -->
                        </a-form-item>
                    </a-form>
                    ...
                    >
                        ...
                        >
                            <p>{{record.inRecordam}}</p>
                            <p>{{record.inRecordpm}}</p>
                        </div>
                        <a
                            class="mx_updata mx_color"
                            slot="operation"
                            slot-scope="text, record, index"
                            @click="mxShowMonth(index)"
                        >查看本月</a>
                    </a-table>
                </div>
                <div v-else>
                    ...
                    <div class="mx_dateList">
                        ...
                        <div class="mx_dateList_right">
                            <div class="mx_dateList_right_name">2019年7月</div>
                            <div>
                                <span
                                    class="mx_mouth"
                                    @click="mxPreMouth"
                ...
                >
                    ...
                    >
                        <div
                            ...
                            slot-scope="text, record, index"
                        >
                            <p>{{record.addressam}}</p>
                            <p>{{record.addresspm}}</p>
                        </div>
                    </template> -->
                    <div
                        v-for="col in ['1', '2', '3', '4', '5','6','7']"
...
for (let i = 0; i < 10; i++) {
    ...
    data.push({
        key: i.toString(),
        canteen: `${canteen}`,
        images: `http://h.hiphotos.baidu.com/lvpics/w=600/sign=5dc3621e19d5ad6eaaf967eab1c939a3/0b55b319ebc4b745cc71eecccdfc1e178b821506.jpg`,
        name: `Edrward ${i}`,
        position: `采购员${i}`,
        jobNum: `ST10${i}`,
        inRecordam: `08:3${i}`,
...
export default {
    data() {
        return {
            ...
            columns: [
                ...
                { title: "职位", width: 100, dataIndex: "position", key: "position" },
                { title: "工号", width: 100, dataIndex: "jobNum", key: "jobNum" },
                { title: "出勤天数", width: 100, dataIndex: "attendance", key: "attendance" },
                {
    ...
    methods: {
        ...
        getListData(value) {
            ...
            // console.log(start)
            // let end = moment(this.date.data).endOf('month').endOf('month')
            // var datas = new Date()
            // console.log(datas.getDate())
            // 当月最后一天
            let end = moment(this.date).endOf('month').endOf('month')
            console.log(end._d.getDate())
            let listData;
            switch (value.date()) {
                // case 7:
                //     listData = this.dataList[i]; break;
                // case 8:
                //     listData = [
                //         { content: 'This is warning event.' },
                ...
                case 15:
                    listData = [
                        { type: '0', content: 'This is warning event' },
                        { type: '1', content: 'This is very long usual event。。....' },
                    ]; break;
                default:
            }
            return listData || [];
        ...
        btn(e) {
            this.m++;
            let x = moment().add(this.m, 'months')
            this.date = x;
        }
    },
    created() {
        let x = moment().add(0, 'months')
        let y = moment().add(-1, 'months')
        this.date = y;
        console.log(x);
        console.log(y);
    }
...
<template>
    <div id="mx_intoLibrary">
                                    ...
                                    <a-col :span="10">
                                        ...
                                        <a-form-item label="获取人">
                                            <a-select
                                                ...
                                                @change="e => inpChangeInfo(e, getPerson.data[e-1].val)"
                        ...
                        <div>
                            ...
                            >
                                    ...
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            >
                                                ...
                                                <a-select-option value="house">小时</a-select-option>
                                            </a-select>
                                        </div>
                                    </div>
                                </a-form-item>
                                ...
                                >
                                    ...
                                    >
                                        <a-select-option value="one">早餐</a-select-option>
                                        <a-select-option value="two">午餐</a-select-option>
                                        <a-select-option value="three">晚餐</a-select-option>
                                        <a-select-option value="four">加餐</a-select-option>
                                    </a-select>
                                </a-form-item>
                                <a-form-item>
                                    <a-button
        ...
        <template>
            <a-timeline>
                <a-timeline-item style="position: relative;marginLeft:150px;" v-for="item in 4">
                    <p style="position: absolute;left:-150px;">2015-09-01&nbsp;&nbsp;15:30</p>
                    <div style="height:300px;border:2px solid #bcbcbc;padding:10px 16px 12px;borderRadius: 5px;">
                        11212121212121
                    </div>
                </a-timeline-item>
            </a-timeline>
...
export default {
    ...
    methods: {
        ...
        getOtherIntoList(keyword) {
            this.$get("api/school/batch?title=" + keyword).then(res => {
                if (res.data.code == 0) {
                    ...
                    console.log(this.otherIntoList);
        ...
        inpSearchInfo(value) {
            ...
            this.$get("api/school/canteen", {}).then(res => {
                if (res.data.code == 0) {
                    // console.log(res);
                    // creenId
                    console.log(that.creenId);
                    let arr = {}
                    res.data.data.filter(item => (item.id == that.creenId)).map(item => (arr = item))
                    // res.data.data.forEach(item => {
                    if (arr.staff.length > 0) {
                        setTimeout(() => {
                            that.getPerson.data = [];
                            arr.staff.forEach((e, i) => {
                                that.getPerson.value = '请选择获取人';
                                let obj = {
                                    key: e.id,
                                    val: e.title,
                                };
                                that.getPerson.data.push(obj);
                            });
                            console.log(that.getPerson);
                            that.getPerson.sc = !that.getPerson.sc;
                        });
                    } else {
                        that.getPerson.ts = true;
                        that.getPerson.sc = true;
                        that.getPerson.data = [];
                    }
                    // })
        ...
        secondSubmit(e) {
            ...
            this.myForm.validateFields((err, values) => {
                if (!err) {
                    ...
                    console.log(this.intoShow);
                    console.log(this.contactMode);
                    console.log(this.intoMode);
                    Object.assign(values, { 'contactMode': this.contactMode, 'intoMode': this.intoMode });
                    this.mxhcData = values;
                    console.log(this.mxhcData);
        ...
        mxPrebtn() {
            ...
            //     canteen: this.mxhcData.canteen,
            //     originMode: this.mxhcData.originMode,
            //     price: this.mxhcData.price,
            //     number: this.mxhcData.number,
            //     warehouse: this.mxhcData.warehouse,
            //     originName: this.mxhcData.originName,
            //     originAddress: this.mxhcData.originAddress,
            // });
        ...
        mxShowInfo(id) {
            this.$get("api/school/record/" + id).then(res => {
                if (res.data.code == 0) {
                    ...
                    res.data.data.forEach(item => {
                        this.acceptanceShow = item;
                        if (item.record_origin == 1) {
                            if (item.record_state == 1) {
                                this.isNormal = true; //正常状态
                            } else if (item.record_state == 3) {
                                this.isNormal = true;  //入库即出库
                            } else {
                                this.isNotInto = true; //拒绝验收
                            }
